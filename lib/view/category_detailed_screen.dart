...
class CategoryDetailedScreen extends StatefulWidget {
  ...
  const CategoryDetailedScreen({super.key, required this.newImage, required this.newsTitle, required this.newsDate, required this.author, required this.description, required this.content, required this.source});

  @override
  State<CategoryDetailedScreen> createState() => _DetailedScreenState();
}

class _DetailedScreenState extends State<CategoryDetailedScreen> {
  @override
